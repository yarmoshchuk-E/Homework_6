public class Main
{
    public static void main(String[] args)
    {
        ...
        else {System.out.println("Если человеку " + age + " лет, то он не достиг совершеннолетия, нужно немного подождать.\n");}
        ...
        else {System.out.println("На улице "+outdoorTemperature+" градусов, можно идти без шапки.\n");}
        ...
        else {System.out.println("Если скорость "+speed+"км/ч, то придется заплатить штраф.\n");}
        ...
        else {System.out.println("Вагон полон. Свободных мест нет.\n");}
